...
<body class="bg-gray-100">
    <header class="bg-blue-600 text-white p-4">
        <h1 class="text-3xl font-bold">Bienvenido al Menú</h1>
    </header>
    <main class="p-6">
        <h2 class="text-2xl font-semibold">Página de Inicio</h2>
        <p class="mt-2 text-gray-700">Esta es la página principal del menú. Navega por las demás secciones.</p>
    </main>
</body>
</html>
